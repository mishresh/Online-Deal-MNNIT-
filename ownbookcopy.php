...
.parallax {
    /* The image used */
    background-image: url(images/book22.jpg) ;
    ...
    while ($row = mysqli_fetch_array($query))
    {
      ...
      echo '<tr>
         ...
         <td>'. date('F d, Y', strtotime($row['date'])) . '</td>
          <td><form action="deletebook.php" method="POST"><input style="display:none" type="text" name="passval" value="'.$row['book_id'].'"><center><input button class="button button2" type="submit" value="DELETE" name="'.$a.'"></center></form></td>
        </tr>';
