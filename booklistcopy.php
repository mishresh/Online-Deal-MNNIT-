...
<div style="padding-left:180px">
  ...
  <table style="width:100%;"><td bgcolor="#A9A9A9" color="#bcf7cb"><h3><b><marquee>WELCOME  <?php echo $name ?></font></marquee></b></h3></td></table>
...
<div style="padding-center:50px; padding-left:50px; color: MidnightBlue; font-size: 20px; text-shadow: -1px 0 black, 0 1px OrangeRed, 1px 0 gold, 0 -1px red;">
  <h2>Total Available Books, Take Action to BYE IT...</h2>
  </div></div>
  <!-- new edition
   -->
...
<!-- <tbody> -->
    ...
    while ($row = mysqli_fetch_array($query))
    {
      echo '<tr>
          ...
          <td><form action="userdetail.php" method="POST"><input style="display:none" type="text" name="passval" value="'.$row['reg'].'"><input style="display:none" type="text"  name="passval2" value="'.$row['book_id'].'"><center><input button class="button button2" type="submit" value="Buy It" name="'.$a.'"></center></form></td>
        </tr>';
